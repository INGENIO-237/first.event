            ...
            <div className="w-full lg:w-1/2 p-4 lg:p-8 flex flex-col justify-center">
                <div className="max-w-md mx-auto w-full">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div className="flex items-start mb-4">
                            <div className="flex items-center h-5 mr-2">
                                <Checkbox id="terms" size={4} checked={terms} onChange={() => setTerms(!terms)} inputBorderColor={errors.acceptedTerms?'focus:border-red-500 focus:ring-red-600' : 'focus:border-indigo-500 focus:ring-indigo-600'} />
                        ...
                        <button type="submit"
                            ...
                            className={cn(isButtonDisabled() ? 'cursor-not-allowed bg-gray-400' : 'bg-orange-500 hover:bg-orange-600', "w-full text-white p-2 rounded transition duration-300")}
                        >
                            Créer un compte
                        </button>
                    </form>
                    ...
                    <div
                        ...
                        <Link href={'/login'} className="text-[#4F4B4F] hover:text-white font-medium  transition-colors  duration-300">
                            Se connecter
                        </Link>
                    </div>
                    <div
                    ...
                    <div className='flex flex-col justify-center items-center gap-4 '>
                        ...
                        <span className='block text-[#9F9D9E]'>Autres Méthodes de connexion</span>
