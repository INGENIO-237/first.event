            ...
            items: [
                {
                    ...
                    imageUrl: 'https://plus.unsplash.com/premium_photo-1675088136456-4eb83fc5b827?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
                    isFollowed: true
                },
                {
                    _id: 2,
                    title: 'Simplykart Inc',
                    subtitle: 'Site informatique et outils',
                    imageUrl: 'https://images.unsplash.com/photo-1725961476494-efa87ae3106a?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwzfHx8ZW58MHx8fHx8',
                    isFollowed: false
                },
                {
                    _id: 3,
                ...
                },
                {
                    ...
                    subtitle: 'Site informatique et outils kwdhbjehbfjwherbfjwhberfjhwbrjdhfbjwhrbfdjwhbrfdjwhbrjdfhbwjrhmbfjehbfh',
                    imageUrl: 'https://images.unsplash.com/photo-1725961476494-efa87ae3106a?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwzfHx8ZW58MHx8fHx8',
                    isFollowed: false
                },
                {
                ...
                if (idx === categoryIndex) {
                    return {
                        ...
                        items: category.items.map(item =>
                            item._id === itemId ? { ...item, isFollowed: !item.isFollowed } : item
                        )
                    };
                }
                return category;
                ...
                <div className="space-y-2">
                    <AnimatePresence>
                        {category.items.map((item) => (
                            ...
                            >
                                <AutoLayout imageUrl={item.imageUrl} subtitle={item.subtitle} title={item.title} /> 
                                <div className="flex flex-col items-end">
                                    <button
                                        onClick={() => handleDelete(categoryIndex, item._id)}
                                        className={`text-xl hover:scale-110 transition duration-300 hover:text-gray-700 ${category.items.length <= 3 ? 'opacity-50 cursor-not-allowed' : ''}`}
            ...
            <div className="grow md:w-1/2 px-4 md:px-5 flex pt-10 md:pt-20 space-y-5 flex-col justify-center md:items-center">
                <div className="md:w-4/6 flex flex-col justify-between py-4 md:py-9 h-full space-y-5">
                    <div className="w-full space-y-4">
                        <h1 className="text-3xl md:text-4xl font-extrabold text-first_violet mb-4 md:mb-6">Suivre <br />les organisateurs <br /><span className='text-[#E35E07]'>à Montreal</span></h1>
                        <span className="text-xs md:text-sm text-balance mb-2">Nous pensons que vous allez adorez ces organisateurs. Suivez-les pour être averti lorsqu&apos;ils ajoutent un nouvel événement</span>
                        <div className="w-full" >
                            <span className='font-medium text-sm md:text-base'>Étape 3 sur 3</span>
                        ...
                        <div className='w-full flex items-center justify-between'>
                            ...
                            />
                            <label className="ml-2 text-xs md:text-sm text-gray-400 w-full" htmlFor="email-send">Envoyez-moi des e-mails sur les meilleurs événements qui se déroulent à proximité ou en ligne</label>
                        </div>
                    </div>
                    <div className="hidden md:flex flex-row justify-between w-full">
                        ...
                        <button
                            ...
                            className={cn(
                                isButtonDisabled ? 'cursor-not-allowed opacity-50' : 'hover:bg-first_orange hover:text-white',
            ...
            <div className="md:w-1/2 grow  md:mt-0 md:bg-[#D9D9D9] overflow-y-scroll space-y-6 md:space-y-10 md:h-screen py-6 md:py-14 pb-16 md:pb-0 no-scrollbar">
                ...
                <div className="md:hidden flex justify-center">
                    <div className="flex flex-row items-center justify-between w-full px-4">
                        <Link href={'/setup-account'} className="border border-first_orange bg-white hover:bg-first_orange p-2 rounded text-first_orange hover:text-white transition duration-300 text-sm">
                            Précedent
                        </Link>
                        <button
                            onClick={handleSubmit}
