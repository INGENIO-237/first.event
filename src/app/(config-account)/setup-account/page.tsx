    ...
    <div className="grow flex flex-col md:flex-row w-full">
      <div className="grow md:w-1/2 flex pt-10 md:pt-0 px-5 space-y-5 flex-col justify-center md:items-center md:m-auto ">
        <div className="md:w-3/6 space-y-5">
          ...
          <span>
            Nous vous suggérons des activités uniques à faire près de chez vous
            et les meilleurs organisateurs de votre région.
          </span>
        </div>
      ...
      <div className="md:w-1/2 grow mx-auto flex md:pt-20 md:place-content-center md:bg-[#D9D9D9] ">
        <div className="space-y-5">
          <div className="text-center">
            <span>Vous recherchez des événements dans:</span>
          </div>
          <form
          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  ...
                  "w-full p-4 border rounded focus:outline-none text-[#4F4B4B] ps-10 block placeholder:text-[#9F9D9D]"
                )}
            ...
            <div className="flex justify-end items-end w-full">
              <button
                ...
                className={cn(
                  isButtonDisabled()
                    ? "cursor-not-allowed  text-white bg-orange-400"
                    : "md:text-first_orange border border-first_orange md:bg-white hover:bg-first_orange rounded hover:text-white text-white   transition duration-300",
                  "p-3 border rounded  bg-first_orange "
                )}
              >
                Continuer
              </button>
