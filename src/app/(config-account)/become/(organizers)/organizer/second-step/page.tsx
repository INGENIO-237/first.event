        ...
        <div className="md:w-5/6 flex flex-col justify- py-9 h-full space-y-5">
          ...
          <div className="flex flex-col w-full gap-2">
            <ExpandRadio
              id="one"
              label={"Juste moi"}
              checked={pastTeam == "Juste moi"}
              onClick={() => setPastTeam("Juste moi")}
            />
            <ExpandRadio
              id="three"
              label={"Quelques personnes (2-10)"}
              checked={pastTeam == "Quelques personnes (2-10)"}
              onClick={() => setPastTeam("Quelques personnes (2-10)")}
            />
            <ExpandRadio
              id="four"
              label={"Une équipe (10+)"}
              checked={pastTeam == "Une équipe (10+)"}
              onClick={() => setPastTeam("Une équipe (10+)")}
            />
          </div>
