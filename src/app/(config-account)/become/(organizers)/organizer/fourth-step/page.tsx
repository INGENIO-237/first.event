...
const fourthStep = () => {
    const [participationEvaluation, setParticipationEvaluation] = useState<string>(localStorage.getItem("participationEvaluation") ?? "");
            ...
            <div className="grow md:w-1/2 px-5 flex pt-20 pb-5 space-y-5 flex-col justify-around md:items-center">
                <div className="md:w-5/6 flex flex-col justify- py-9 h-full space-y-5">
                    ...
                    <div className="flex flex-col w-full gap-2">
                        <ExpandRadio id="one" label={"De petite ampleur et privés (1-20)"} checked={participationEvaluation == "De petite ampleur et privés (1-20)"} onClick={() => setParticipationEvaluation("De petite ampleur et privés (1-20)")} />
                    ...
                    <div className="flex justify-around w-5/6">
                        ...
                        <button
                            ...
                            className={cn(" rounded py-2 text-center text-white w-2/6 ", participationEvaluation == "" ? "cursor-not-allowed bg-gray-400 " : "bg-first_orange hover:bg-orange-600 transition duration-300")} >
                            Suivant</button>
                    </div>
                </div>
            </div>
