...
import ChannelView from "@/components/custom/config-account/ChannelView";
import ExpandInput from "@/components/custom/config-account/ExpandInput";
...
const FourthStep = () => {
  ...
  const removeChannel = (channelIndex: number) => {
    setChannels((prevChannels) => [
      ...prevChannels.filter((item, index) => {
          ...
          <div className="space-y-4">
            <div className="w-full space-y-4">
              <h1 className="text-3xl font-extrabold text-first_violet">
                Quels sont vos canaux de communication et le nombre
                d&apos;abonnés ?
              </h1>
            ...
            <div className="flex flex-col w-full gap-2">
              <form
                ...
                onSubmit={submitForm((d) => handleSubmitForm(d))}
              >
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-row gap-2 items-center">
                    ...
                    <button
                      type="submit"
                      className={cn(
                        "rounded-full w-7 h-7 flex items-center border border-first_violet  text-center text-first_violet self-start"
                      )}
                    >
                      <Check />
                    </button>
