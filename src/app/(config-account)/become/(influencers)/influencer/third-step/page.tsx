        ...
        <div className="md:w-5/6 flex flex-col justify- py-9 h-full space-y-5">
          ...
          <div className="flex flex-col w-full gap-2">
            <ExpandRadio
              id="one"
              label={"Juste un"}
              checked={pastEvent == "Juste un"}
              onClick={() => setPastEvent("Juste un")}
            />
            <ExpandRadio
              id="two"
              label={"Quelques-uns (2-12)"}
              checked={pastEvent == "Quelques-uns (2-12)"}
              onClick={() => setPastEvent("Quelques-uns (2-12)")}
            />
            <ExpandRadio
              id="three"
              label={"Beaucoup (12+)"}
              checked={pastEvent == "Beaucoup (12+)"}
              onClick={() => setPastEvent("Beaucoup (12+)")}
            />
            <ExpandRadio
              id="four"
              label={"Aucun"}
              checked={pastEvent == "Aucun"}
              onClick={() => setPastEvent("Aucun")}
            />
          </div>
          <div className="flex justify-around w-5/6">
            <Link
              href={"/become/influencer/second-step"}
