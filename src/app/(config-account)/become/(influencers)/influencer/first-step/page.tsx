    ...
    <div className="grow flex flex-col md:flex-row w-full h-screen">
      <div className="grow md:w-1/2 px-5 flex pt-20 pb-5 space-y-5 flex-col justify-around md:items-center">
        <div className="md:w-5/6 flex flex-col justify- py-9 h-full space-y-5">
          ...
          <ExpandRadio
            id="one"
            label={"Non c'est ma première experience"}
            checked={experience == "Non c'est ma première experience"}
            onClick={() => setExperience("Non c'est ma première experience")}
          />
          <ExpandRadio
            id="two"
            label={"J'ai un peu d'éxpérience en communication d'événements"}
            checked={
              experience ==
              "J'ai un peu d'éxpérience en communication d'événements"
            }
            onClick={() =>
              setExperience(
                "J'ai un peu d'éxpérience en communication d'événements"
          ...
          <ExpandRadio
            id="three"
            label={"J'ai beaucoup d'experience en communication d'événements"}
            checked={
              experience ==
              "J'ai beaucoup d'experience en communication d'événements"
            }
            onClick={() =>
              setExperience(
                "J'ai beaucoup d'experience en communication d'événements"
