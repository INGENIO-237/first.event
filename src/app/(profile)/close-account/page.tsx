  ...
  return (
    <div className="container mx-auto px-4 md:px-20 py-8 flex flex-col gap-y-8">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
        <Dialog
          open={isTemporaryCloseOpen}
          onOpenChange={setIsTemporaryCloseOpen}
        >
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Êtes-vous sûr de vouloir fermer temporairement votre compte ?
            ...
            <DialogFooter>
              <Button
                className="rounded"
                variant="outline"
                onClick={() => setIsTemporaryCloseOpen(false)}
              >
                Annuler
              </Button>
              <Button
                onClick={handleTemporaryClose}
                className="bg-first_orange hover:bg-first_orange/90 text-white rounded"
              >
                Confirmer
              </Button>
            </DialogFooter>
        ...
        <Dialog
          open={isPermanentCloseOpen}
          onOpenChange={setIsPermanentCloseOpen}
        >
          <DialogTrigger asChild>
            <Button
              size="lg"
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                seront supprimées définitivement. Êtes-vous absolument sûr de
                vouloir procéder ?
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
              <Button
                className="rounded"
                variant="outline"
                onClick={() => setIsPermanentCloseOpen(false)}
              >
                Annuler
              </Button>
              <Button
