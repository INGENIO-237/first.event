    ...
    <div className="grow min-h-full mt-20 md:mt-0 w-screen flex md:flex-row flex-col">
      <div className="flex flex-col h-screen md:w-3/5 gap-5 p-5">
        <span className="space-x-1 text-sm">
          <Link href={"/"} className="underline p-1 text-first_violet">
            Acceuil
          </Link>
          /
          <Link href={"#"} className="underline p-1 text-first_violet">
        ...
        <div className="space-y-3">
          <div>
            <h1 className="text-2xl font-bold text-center md:text-start text-first_violet">
              Événements à Montréal, Canada
            </h1>
            <h2 className="text-center md:text-start font-medium">
              Recherchez quelque chose que vous aimez ou consultez les
              événements populaires dans votre région
            </h2>
          </div>
          <div className="flex md:flex-row ">
            <div>
              ...
              <div>
                <div className="py-2">
                  <span className="text-['#5F5E5E'] text-base font-semibold">
                    Catégorie
                  </span>
                    ...
                    <div className="space-x-4 px-4 font-medium text-center">
                      {visibleCount < interests.length && (
                        <motion.span
                          ...
                          transition={{ duration: 0.75 }}
                          className="text-first_violet text-center text-base hover:underline transition duration-300"
                        >
                          {" "}
                          Voir plus
                        </motion.span>
                      ...
                      {visibleCount > 5 && (
                        <motion.span
                          ...
                          transition={{ duration: 0.75 }}
                          className="text-first_violet text-center text-base transition duration-300"
                        >
                          {" "}
                          Voir moins
                        </motion.span>
      ...
      <div className="flex justify-center border items-center bg-black h-screen md:w-2/5"></div>
    </div>
  );
};
