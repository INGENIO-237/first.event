...
const DashboardOrganizersCaroussel = ({
  title,
  organizers,
}: CarousselProps) => {
  return (
                ...
                <Card className="w-full rounded-lg py-4">
                  ...
                  <CardContent className="flex-col flex justify-center space-y-4">
                    <div className="flex gap-x-4 items-center justify-center">
                      <button
                        className={cn(
                          "p-3 rounded",
                          organizer.liked
                            ? "bg-first_violet text-white"
                            : "border border-first_violet text-first_violet hover:bg-first_violet hover:text-white"
                        )}
                      >
                        {organizer.liked ? "Suivi(e)" : "Suivre"}
                      </button>
                      <Link
                        href={"#"}
                        className="border border-first_violet text-first_violet hover:bg-first_violet hover:text-white p-3 rounded "
                      >
                        Contact
                      </Link>
                    </div>
                    <div className="text-center ">
                      <p>{organizer.eventsCount}</p>
                      <p>
                    ...
                    <div className="flex justify-center">
                      <Link
                        href={organizer.askLink}
                        className=" underline underline-offset-2 decoration-first_gray hover:decoration-first_violet hover:text-first_violet  "
                      >
                        Envoyer une demande
                      </Link>
                    </div>
